...
export class LeetcodeQuery {
    ...
    async fetchUserSolvedProblemsStats(userName: string): Promise<SubmitStats> {
        ...
        stats.totalSubmissionNum = data.matchedUser.submitStats.totalSubmissionNum;
        stats.problemsSolvedBeatsStats = data.matchedUser.problemsSolvedBeatsStats;
